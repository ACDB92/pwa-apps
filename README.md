# pwa-apps — miroir de déploiement

Repo **public** servant nos PWAs via GitHub Pages. Les **sources vivent dans le repo privé
`AC_perso`** (`Projects/ttmc-pwa/`, `Projects/mental-math-pwa/`) — ne pas éditer ici, ce repo
est un miroir « dist » écrasé à chaque mise à jour.
